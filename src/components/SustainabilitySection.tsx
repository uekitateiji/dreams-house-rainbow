  ...
  const sustainabilityData = [
    {
      ...
      description: "QuikHouse construye con máxima economía en línea con prácticas sostenibles, ofreciendo soluciones eficientes y rentables para cada proyecto.",
      delay: 0.2
    },
    {
      ...
      title: "MENOR TIEMPO DE EJECUCIÓN",
      description: "El sistema QuikHouse es un modelo simplificado que hace que todo el proceso de construcción sea más rápido y con un resultado final superior.",
      delay: 0.4
    },
    {
      ...
      description: "El ensamblaje completamente inteligible elimina costos adicionales de mano de obra y evita el desperdicio de materiales en obra.",
      delay: 0.6
    }
  ];
